    ...
    <div className="space-y-12 pb-24 font-mono select-none">
      ...
      <header className="flex flex-col gap-10 border-b border-primary/10 pb-12">
        <div className="flex items-center">
           ...
           <button 
              onClick={() => logout()}
              className="px-8 h-12 bg-black text-white flex items-center justify-center gap-4 text-[9px] font-black uppercase tracking-[0.3em] hover:bg-black transition-all shadow-xl active:scale-95 whitespace-nowrap"
           >
              ...
              <div className="relative z-10 space-y-12">
                 ...
                 <div className="space-y-4">
                    {[
                       ...
                       <div key={i} className="flex items-center gap-4 text-[10px] font-black text-black/60 tracking-widest border-l-2 border-white/10 pl-6 group-hover:border-gold transition-colors">
