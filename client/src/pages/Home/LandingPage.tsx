          ...
          <div className="max-w-[1400px] mx-auto px-8 grid lg:grid-cols-2 gap-20 items-center relative z-10">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <button className="border-2 border-white/20 bg-white/5 backdrop-blur-sm text-white px-8 py-3 text-base font-medium rounded-lg hover:bg-white hover:text-[#425664] transition-all">
                  Bulk Order Inquiry
                </button>
              </div>
            </motion.div>
        ...
        <section className="mx-8 bg-[#425664] rounded-[32px] overflow-hidden py-[100px] relative">
          ...
          <div className="max-w-[1400px] mx-auto px-12 relative z-10 grid lg:grid-cols-2 gap-20 items-center text-center lg:text-left">
            <div className="space-y-8">
              ...
              <button className="bg-[#C6AD8F] text-white px-8 py-3 text-base font-medium rounded-lg hover:brightness-110 shadow-lg transition-all">
