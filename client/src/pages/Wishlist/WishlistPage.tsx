...
export default function WishlistPage() {
  ...
  return (
    <div className={`bg-[#D6D6D6] ${wishlist.length === 0 ? 'h-screen overflow-hidden' : 'min-h-screen'} selection:bg-[#000000] selection:text-[#D6D6D6] font-sans`}>
      <main className={`max-w-[1400px] mx-auto px-8 pt-12 space-y-12 ${wishlist.length === 0 ? '' : 'pb-32'}`}>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-10">
            ...
            <div className="p-10 max-w-md mx-auto text-center space-y-6 bg-white border border-[#000000]/10 rounded-[40px] shadow-sm my-20">
               <div className="w-20 h-20 rounded-full bg-[#D6D6D6] flex items-center justify-center mx-auto border border-[#000000]/5">
                  <Heart size={32} className="text-[#000000]/30" />
               </div>
               <div className="space-y-2">
                  <h3 className="text-xl font-bold tracking-tight text-[#000000]">Wishlist Empty</h3>
                  <p className="text-[13px] font-medium text-[#000000]/60 leading-relaxed">Your wishlist is currently empty. Explore our catalog to find items.</p>
               </div>
               <div className="pt-2">
                  <button 
