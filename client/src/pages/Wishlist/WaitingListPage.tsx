            ...
            {displayedList.length > 0 ? (
               ...
               <div className="py-60 text-center space-y-10 bg-white border border-[#425664]/5 rounded-[60px] shadow-sm">
                  ...
                  <div className="space-y-4">
                     ...
                     <p className="text-xs font-medium text-[#6B7280] uppercase tracking-widest max-w-sm mx-auto leading-relaxed">No wholesale assets match current filters.</p>
                     <div className="pt-8">
                        <button onClick={() => { setFilterMode('All'); setSortBy('featured'); }} className="inline-flex items-center gap-3 text-[#C6AD8F] font-semibold text-xs uppercase tracking-widest hover:gap-5 transition-all">
                           Reset Filter Options <ArrowRight size={16} />
                        </button>
                     </div>
                  </div>
               </div>
