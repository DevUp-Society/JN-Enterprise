                 ...
                 <div className="grid grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <input 
                      ...
                      className={`w-full h-16 bg-bone border ${formData.email && !isEmailValid ? 'border-red-500' : 'border-primary/5'} px-8 text-[11px] font-black tracking-widest uppercase focus:border-primary transition-all`}
                         ...
                         <div key={item.sku} className="flex justify-between items-center py-4 border-b border-primary/5 last:border-0 opacity-60 hover:opacity-100 transition-opacity">
                            <div className="space-y-1">
                               ...
                               <p className="text-[8px] font-bold text-primary/30 uppercase tracking-widest">
                                  SKU: {item.sku} • {Object.values(item.sizeQuantities).reduce((a, b) => a + b, 0)} Units
                               </p>
                            </div>
